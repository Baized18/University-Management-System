...
// Class for Teacher Leave Application
public class TeacherLeave extends JFrame implements ActionListener {

    // UI Components
    Choice cEmpId, ctime;   // Dropdowns for Employee ID and leave duration
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == submit) {
            ...
            String empId = cEmpId.getSelectedItem(); // get selected Employee ID
